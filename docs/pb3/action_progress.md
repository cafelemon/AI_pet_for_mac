...
- Total planned actions: 33
- WebM complete: 18
- Source videos ready, pending WebM conversion: 0
- Waiting for source videos: 15
...
| PB1 | 原有核心 | `sleep` (sleep) | `loop` | yes | kling | `none` | `sleep_props` | `none` | yes | yes | yes | 完成：WebM 已生成 | `assets/states/sleep/source/kling_sleep.mp4` |
...
| PB2 | 原有核心 | `thinking` (thinking) | `loop` | yes | kling | `kling_corner` | `white` | `none` | yes | yes | yes | 完成：WebM 已生成 | `assets/states/thinking/source/thinking_jimeng.mp4` |
...
| PB3.1 | 待机小动作 | `idle_reading` (reading) | `short_loop` | yes | jimeng | `jimeng_corner` | `neutral_floor` | `none` | yes | yes | yes | 完成：WebM 已生成 | `assets/states/idle_reading/source/idle_reading_jimeng.mp4` |
...
| Priority Idle V1 | 姿态衔接 | `duck_sit_to_sleep` (duck sit to sleep) | `one_shot` | yes | kling | `none` | `sleep_props` | `duck_sit_to_sleep` | no | yes | yes | 完成：WebM 已生成 | `assets/states/duck_sit_to_sleep/source/kling_duck_sit_to_sleep.mp4` |
...
| PB3.1 | 待机小动作 | `bored` (bored) | `loop` | no | unknown | `none` | `white` | `none` | no | no | no | 待补源视频 | `assets/states/bored/source/bored_source.mp4` |
| PB3.1 | 生活互动 | `stretch` (stretch) | `one_shot` | no | unknown | `none` | `white` | `none` | no | no | no | 待补源视频 | `assets/states/stretch/source/stretch_source.mp4` |
| PB3.1 | 生活互动 | `drink` (drink) | `short_loop` | no | unknown | `none` | `white` | `none` | no | no | no | 待补源视频 | `assets/states/drink/source/drink_source.mp4` |
| PB3.1 | 趣味互动 | `hide` (hide) | `one_shot` | no | unknown | `none` | `white` | `none` | no | no | no | 待补源视频 | `assets/states/hide/source/hide_source.mp4` |
| PB2 | 启动互动 | `wave` (wave) | `one_shot` | no | unknown | `none` | `white` | `none` | no | no | no | 待补源视频 | `assets/states/wave/source/wave_source.mp4` |
| PB3.2 | 任务过渡 | `loading` (loading) | `loop` | no | unknown | `none` | `white` | `none` | no | no | no | 待补源视频 | `assets/states/loading/source/loading_source.mp4` |
| PB3.2 | 任务过渡 | `search` (search) | `short_loop` | no | unknown | `none` | `white` | `none` | no | no | no | 待补源视频 | `assets/states/search/source/search_source.mp4` |
| PB3.2 | 任务过渡 | `explain` (explain) | `short_loop` | no | unknown | `none` | `white` | `none` | no | no | no | 待补源视频 | `assets/states/explain/source/explain_source.mp4` |
| PB3.2 | 系统状态 | `update` (update) | `loop` | no | unknown | `none` | `white` | `none` | no | no | no | 待补源视频 | `assets/states/update/source/update_source.mp4` |
| PB3.3 | 情绪反馈 | `shy` (shy) | `one_shot` | no | unknown | `none` | `white` | `none` | no | no | no | 待补源视频 | `assets/states/shy/source/shy_source.mp4` |
| PB3.3 | 情绪反馈 | `angry` (angry) | `one_shot` | no | unknown | `none` | `white` | `none` | no | no | no | 待补源视频 | `assets/states/angry/source/angry_source.mp4` |
| PB3.3 | 情绪反馈 | `cheer` (cheer) | `one_shot` | no | unknown | `none` | `white` | `none` | no | no | no | 待补源视频 | `assets/states/cheer/source/cheer_source.mp4` |
| PB3.3 | 情绪反馈 | `confused` (confused) | `short_loop` | no | unknown | `none` | `white` | `none` | no | no | no | 待补源视频 | `assets/states/confused/source/confused_source.mp4` |
| PB3.3 | 退出状态 | `bye` (bye) | `one_shot` | no | unknown | `none` | `white` | `none` | no | no | no | 待补源视频 | `assets/states/bye/source/bye_source.mp4` |
| PB3.3 | 情绪增强 | `happy` (happy) | `short_loop` | no | unknown | `none` | `white` | `none` | no | no | no | 待补源视频 | `assets/states/happy/source/happy_source.mp4` |
